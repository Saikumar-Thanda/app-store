...
class AppStore extends Component {
  ...
  getFilteredAppList = searchedCategory => {
    const {ActiveTabId} = this.state
    const filteredAppList = searchedCategory.filter(
  ...
  render() {
    ...
    const filteredList = this.getFilteredAppList(searchResults)
    return (
